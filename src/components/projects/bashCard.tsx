    ...
    return (
        ...
        >
            ...
            <footer className={`${!showItems ? "hidden" : ""} z-20 flex flex-col mt-4 xs:mt-10 sm:mt-20`}>
                <a href="https://github.com/Angelagex/bashScripting" target="_blank" className="m-auto flex items-center justify-center interactable z-20">
                    ...
                    <p className="text-[0.65rem] leading-3 sm:text-xs md:text-sm pl-2 sm:pl-0">bashScripting</p>

                </a>
            </footer>
            <Image placeholder="blur" blurDataURL="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="src={"/scripting.gif"} width={500} height={500} className={`w-full h-full absolute -ml-2 rounded-3xl object-cover ${!showItems ? opacityHandler.out : opacityHandler.in}`} alt="" loading="lazy" />
        </article>
    );
}
