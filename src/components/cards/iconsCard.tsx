...
export default function IconsCard({ theme }: { theme: string }) {
    return (
        <div className={`${theme == "dark" ? "yellow_card" : "yellow_card_light grain" } col-span-1 relative rounded-3xl flex justify-center items-center gap-4 lg:gap-5 texl-2xl lg:text-3xl flex-wrap
