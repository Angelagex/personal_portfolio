export default function ProfileCard({ theme }: { theme: string }) {
    return (
        <article className={`${theme == "dark" ? "purple_mix_card" : "purple_mix_card_light" } relative col-span-3 h-80 md:h-auto md:aspect-auto md:row-span-2 rounded-3xl overflow-hidden flex justify-center items-center p-6`}>
