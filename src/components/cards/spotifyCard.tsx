  ...
  return (
    <div className={`${theme == "dark" ? "white_card" : "white_card_light grain" } rounded-3xl col-span-2 row-span-1 overflow-hidden p-4 pt-6 pl-12 md:p-8 md:pl-[3.8rem] lg:p-12 lg:pl-20`}>
      <a
        ...
        aria-label="Spotify"
      >
        <Image src={spotifyIcon}  width={20} height={20} alt="spotifyIcon2" className="-z-1 absolute w-24 top-4 -left-4 md:-left-4 lg:top-10 lg:left-0 xl:top-8 xl:-left-4 lg:w-30 xl:w-36 interactable" />
      </a>
      ...
      <a
        ...
        aria-label="Spotify"
      >
        <Image src={"/spotifyMood.gif"} width={20} height={20} alt="spotifyIcon" className="interactable z-20 absolute bottom-0 right-0 w-28 xl:w-36" />
      </a>
