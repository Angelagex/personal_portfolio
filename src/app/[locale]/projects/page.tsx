    ...
    return (
        <main>
            ...
            <div className="grid gap-2 grid-cols-3 grid-rows-4 md:gap-4 my-5 container mx-auto xl:px-20">
                <BashCard theme={theme} language={language}/>
                <DesignPatternsCard theme={theme} language={language}/>
                <PokeStoreCard theme={theme} language={language}/>
                <PortfolioCard theme={theme} language={language}/>
